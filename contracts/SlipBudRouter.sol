...
contract SlipBudRouter is IRouter, IFlashLoanSimpleReceiver, AccessControl, ReentrancyGuard {
        ...
        returns (uint256 profit)
    {
        ...
        // 5. HER ŞEYİ Treasury'ye geri gönder (çekilen miktar + kar) — CEI: state önce
    ...
    /// @inheritdoc IRouter
    function executeFlashLoan(FlashLoanParams calldata params) external override nonReentrant onlyRole(BOT_ROLE) {
